    ...
    private void cliente(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cliente
        ...
        switch (opcion) {
            ...
            case "Listar Clientes":
                ViewListaCliente vlcliente = new ViewListaCliente();
                vlcliente.setLocationRelativeTo(null);
                vlcliente.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                vlcliente.setVisible(true);
                break;
            case "Nuevo Producto":
            ...
            case "Listar Producto":
                ViewListaProducto vlproductos = new ViewListaProducto();
                vlproductos.setLocationRelativeTo(null);
                vlproductos.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                vlproductos.setVisible(true);
                break;
            case "Salir":
